...
class Item(object):
    ...
    """
    def __init__(self, name, description, units, unit_sellprice, unit_priceexVAT, unit_vatamount):
        """
        Item modal init
        ...
        self.units = units
        self.unit_price = unit_sellprice
        self.unit_exVATprice = unit_priceexVAT
        self.unit_vatAmount = unit_vatamount
